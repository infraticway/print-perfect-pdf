...
export const ITEMS: MenuItem[] = [
  ...
  { id: "agua-sem-gas", label: "Água Sem Gás", section: "Bebidas Geladas", page: 3, x: 16.24, y: 21.75 },
  { id: "agua-com-gas", label: "Água Com Gás", section: "Bebidas Geladas", page: 3, x: 16.24, y: 25.11 },
  { id: "refrigerante", label: "Refrigerante (350ml)", section: "Bebidas Geladas", page: 3, x: 16.24, y: 19.58 },
  { id: "suco", label: "Suco (300ml)", section: "Bebidas Geladas", page: 3, x: 16.24, y: 25.11 },

  // ====== PÁGINA 3 — Bebidas Geladas (coluna meio, x=42%) ======
  { id: "soda-italiana", label: "Soda Italiana (380ml)", section: "Bebidas Geladas", page: 3, x: 41.19, y: 26.08 },
  { id: "cha-batido-gelado", label: "Chá Batido & Gelado (480ml)", section: "Bebidas Geladas", page: 3, x: 41.19, y: 33.49 },
  { id: "alfajor-au-cafe", label: "Alfajor au Café (200ml)", section: "Bebidas Geladas", page: 3, x: 41.11, y: 47.92 },
  { id: "cappuccino-helado", label: "Cappuccino Helado Dulce de Leche (330ml)", section: "Bebidas Geladas", page: 3, x: 41.19, y: 53.91 },
  { id: "havanna-shake", label: "Havanna Shake", section: "Bebidas Geladas", page: 3, x: 41.19, y: 59.78 },
  { id: "latte-helado", label: "Latte Helado (300ml)", section: "Bebidas Geladas", page: 3, x: 41.19, y: 59.78 },
  ...
  { id: "pdq-tradicional", label: "Pão de Queijo Tradicional (70g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 60.35 },
  { id: "pdq-recheado", label: "Pão de Queijo Recheado c/ Doce de Leite (75g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 64.0 },
  { id: "mini-pdq", label: "Mini Pão de Queijo - Porção 8 unid. (120g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 68.5 },
  { id: "coxinha-frango", label: "Coxinha de Frango com Requeijão (110g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 73.06 },
  { id: "coxinha-costela", label: "Coxinha de Costela com Requeijão (110g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 77.45 },
  { id: "bauruzinho", label: "Bauruzinho de Presunto e Queijo (130g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 82.24 },
  { id: "folhado-frango", label: "Folhado de Frango com Azeitona (130g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 86.97 },
  { id: "torta-frango", label: "Torta de Frango — fatia (150g)", section: "Clássicos Brasileiros", page: 4, x: 41.15, y: 86.97 },
  ...
  { id: "choripan", label: "Choripan (235g)", section: "Especiais Havanna", page: 4, x: 91.13, y: 75.4 },
  { id: "croque-el-senor", label: "Croque El Señor (200g)", section: "Especiais Havanna", page: 4, x: 91.13, y: 82.35 },
  ...
  { id: "bolo-red-velvet", label: "Bolo Red Velvet (170g)", section: "Doces", page: 5, x: 21.52, y: 28.65 },
  { id: "brownie-dulce", label: "Brownie com Dulce de Leche (185g)", section: "Doces", page: 5, x: 21.52, y: 35.21 },
  { id: "torta-havanna", label: "Torta Havanna (120g)", section: "Doces", page: 5, x: 21.52, y: 40.51 },
  { id: "torta-havanna-zero", label: "Torta Havanna Zero (120g)", section: "Doces", page: 5, x: 21.52, y: 47.52 },
  { id: "torta-la-chocolina", label: "Torta La Chocolina (100g)", section: "Doces", page: 5, x: 21.52, y: 53.51 },
  { id: "mini-torta-dulce", label: "Mini Torta Dulce de Leche (90g)", section: "Doces", page: 5, x: 21.52, y: 59.61 },
  { id: "mini-torta-amendoas", label: "Mini Torta de Amêndoas (90g)", section: "Doces", page: 5, x: 21.52, y: 66.62 },
  { id: "mini-torta-limao", label: "Mini Torta de Limão (90g)", section: "Doces", page: 5, x: 21.52, y: 72.26 },
  { id: "mini-torta-banana", label: "Mini Torta Crumble de Banana (90g)", section: "Doces", page: 5, x: 21.52, y: 79.16 },
  { id: "petit-gateau", label: "Petit Gateau de Dulce de Leche (140g)", section: "Doces", page: 5, x: 21.52, y: 90.45 },
  { id: "churros", label: "Churros (4 unid.)", section: "Doces", page: 5, x: 21.52, y: 84.64 },
  ...
  { id: "alfajor-chocolate-leite", label: "Alfajor Solito Chocolate ao Leite (55g)", section: "Alfajores", page: 6, x: 20.31, y: 21.35 },
  { id: "alfajor-chocolate-branco", label: "Alfajor Solito Chocolate Branco (55g)", section: "Alfajores", page: 6, x: 20.31, y: 23.46 },
  ...
  { id: "alfajor-vegano", label: "Alfajor Vegano (70g)", section: "Alfajores", page: 6, x: 41.23, y: 37.37 },
  ...
  { id: "barrita", label: "Barrita (30g)", section: "Clássicos", page: 6, x: 70.29, y: 15.31 },
  { id: "galletita-limon", label: "Galletita de Limón (35g)", section: "Clássicos", page: 6, x: 70.29, y: 21.24 },
  { id: "havannet-solito", label: "Havannet Solito (38g)", section: "Clássicos", page: 6, x: 70.29, y: 27.0 },
  { id: "caixa-6-havannets", label: "Caixa com 6 Havannets", section: "Clássicos", page: 6, x: 70.29, y: 40.22 },

  { id: "ddl-tradicional-170", label: "Dulce de Leche Tradicional — Pote 170g", section: "Dulce de Leche", page: 6, x: 70.29, y: 53.91 },
  { id: "ddl-tradicional-420", label: "Dulce de Leche Tradicional — Pote 420g", section: "Dulce de Leche", page: 6, x: 70.29, y: 59.21 },
  { id: "ddl-tradicional-700", label: "Dulce de Leche Tradicional — Pote 700g", section: "Dulce de Leche", page: 6, x: 70.29, y: 66.85 },
  { id: "ddl-zero-acucar", label: "Dulce de Leche Zero Açúcar — Pote 420g", section: "Dulce de Leche", page: 6, x: 70.29, y: 66.85 },
  { id: "ddl-zero-lactose", label: "Dulce de Leche Zero Lactose — Pote 420g", section: "Dulce de Leche", page: 6, x: 70.29, y: 66.85 },
  ...
  { id: "caixa-4-alfajores", label: "Caixa com 4 Alfajores (70%/Mar del Plata/Sem Açúcar/Pistache)", section: "Caixas", page: 6, x: 91.13, y: 17.82 },
  { id: "caixa-6-leite", label: "Caixa com 6 Alfajores — Chocolate ao Leite", section: "Caixas", page: 6, x: 91.21, y: 28.59 },
  { id: "caixa-6-merengue", label: "Caixa com 6 Alfajores — Merengue", section: "Caixas", page: 6, x: 91.13, y: 40.22 },
  { id: "caixa-6-misto", label: "Caixa com 6 Alfajores — Misto", section: "Caixas", page: 6, x: 91.13, y: 40.22 },
  { id: "caixa-12-leite", label: "Caixa com 12 Alfajores — Chocolate ao Leite", section: "Caixas", page: 6, x: 91.13, y: 40.22 },
