            ...
            >
              ...
              {pagePins.map((pin) =>
                pin.price == null ? null : (
                  <div
                    key={pin.id}
                    className="absolute -translate-x-1/2 -translate-y-1/2 whitespace-nowrap rounded px-[0.3cqi] py-[0.1cqi] text-[1.4cqi] font-bold leading-tight tracking-tight shadow-sm"
                    style={{
                      left: `${pin.x}%`,
                      top: `${pin.y}%`,
